...
export const ChatArea = () => {
  return (
    <div className="bg-black p-[4px] flex flex-col gap-4 rounded-x20">
      ...
      <div className="flex justify-between items-center p-2">
        <div className="flex gap-4">
          ...
          >
            ...
            <Button variant="tetiaryText" className="text-medium-base text-white" startContent={<span>{SettingsIcon}</span>}>Set preferences</Button>
          </GradientBorder>
          <GradientBorder
            classNames={{
              root: "w-fit rounded-[90px] group",
          ...
          >
            ...
            <Button variant="tetiaryText" className="text-medium-base text-white" startContent={<span>{SettingsIcon}</span>}>Clear</Button>
          </GradientBorder>
        </div>
        ...
        >
          ...
          <Button className="p-4" variant="tetiaryText"><span>{SendIcon}</span></Button>
        </GradientBorder>
      </div>
    </div>
  )
