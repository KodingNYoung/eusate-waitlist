...
export const DevActionCard: FC<Props> = ({ title, description, classNames }) => {
  return (
    <div className={cls("grid items-between p-4 rounded-lg bg-white min-h-[219px]", classNames?.root)}>
      <span>{DevIcon}</span>
