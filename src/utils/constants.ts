...
export const PRICING: PricingPlan[] = [
  {
    ...
    features: [
      ...
      { text: "50K Sate tokens", checked: true },
...

  {
    ...
    features: [
      ...
      { text: "AI chat monitoring", checked: true },
      { text: "1 agent seat", checked: true },
      { text: "200K Sate tokens", checked: true },
...

  {
    ...
    features: [
      ...
      { text: "AI chat monitoring", checked: true },
      { text: "1 agent seat", checked: true },
      { text: "1M Sate tokens", checked: true },
...

  {
    ...
    features: [
      ...
      { text: "AI chat monitoring", checked: true },
      { text: "1 agent seat", checked: true },
      { text: "10M Sate tokens", checked: true },
