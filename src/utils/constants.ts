...
export const PRICING: PricingPlan[] = [
  {
    ...
    redirect: "/signup",
    features: [
      "Knowledge Base: 512KB storage",
      "Human Agent Seats: 1 seats included",
      "AI Tokens: 50K S8 tokens",
      "DevSpace Functions: 0 function",
      "Chat SDK: Included",
      "Playground: Full access",
      "Copilot Support: 0 message per ticket",
      "AI Chat Monitoring: Included (human agents can monitor AI-handled conversations in real-time)",
      "No Saved Responses",
      "No AI call",
      "Addons disallowed",
    ],
  ...
  },
  {
    ...
    recomended: true,
    features: [
      "Knowledge Base: 20MB storage",
      "Human Agent Seats: 1 seats included",
      "AI Tokens: 10 million S8 tokens",
      "DevSpace Functions: 20 functions",
      "Chat SDK: Included",
      "Playground: Full access",
      "Copilot Support: unlimited messages per ticket",
      "AI Chat Monitoring: Included (human agents can monitor AI-handled conversations in real-time)",
      "Addons allowed",
      "AI Call: 5mins per call session",
      "Saved Responses",
    ],
    action: () => {},
  },
  {
    ...
    features: [
      "Knowledge Base: 2MB storage",
      "Human Agent Seats: 1 seats included",
      "AI Tokens: 200K S8 tokens",
      "DevSpace Functions: 5 functions",
      "Chat SDK: Included",
      "Playground: Full access",
      "Copilot Support: 5 messages per ticket",
      "AI Chat Monitoring: Included (human agents can monitor AI-handled conversations in real-time)",
      "Saved Responses",
      "No AI Call",
      "Addons allowed",
  ...
  },
  {
    ...
    features: [
      ...
      "Human Agent Seats: 1 seats included",
      "AI Tokens: 1 million S8 tokens",
      "DevSpace Functions: 10 functions",
      "Chat SDK: Included",
      "Playground: Full access",
      "Copilot Support: 20 messages per ticket",
      "AI Chat Monitoring: Included (human agents can monitor AI-handled conversations in real-time)",
      "Addons allowed",
      "AI Call: 5mins per call session",
      "Saved Responses",
