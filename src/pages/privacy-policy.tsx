            ...
            <ol className="list-outside list-[lower-alpha] pl-5 mt-3 space-y-3">
                ...
                <ul className="list-disc list-outside pl-4 space-y-2">
                  <li>
                    <Typography
                      ...
                      className="text-gray-600 leading-relaxed text-regular-sm sm:text-regular-lg"
                    >
                      Usage data (e.g., pages visited, features used, date/time
                      of access).
                    </Typography>
                  </li>
                  <li>
              ...
              <li className="text-medium-base sm:text-medium-lg">
                ...
                >
                  ...
                  your customers’ personal data (e.g., names, emails,
                  conversation history). You are the “data controller” for such
                  information; Eusate acts as a “data processor” in accordance
