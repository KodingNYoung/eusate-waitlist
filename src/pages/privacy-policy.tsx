    ...
    <div>
      ...
      >
        ...
        <PolicySection title="1. Introduction">
          ...
          >
            Eusate (“we,” “us,” or “our”) is committed to protecting the privacy
            and security of our users and their customers. This Privacy Policy
            explains how we collect, use, store, and protect your personal
            information when you access or use our AI-powered customer support
            platform, including during the Early Tester Program. By using our
          ...
          <ol className="list-outside list-[lower-alpha] pl-5 mt-3 space-y-3">
              ...
              <ul className="list-disc list-outside pl-4 space-y-2">
                ...
                <li>
                  ...
                  >
                    ...
                    tickets, conversation logs, documents, and uploaded files.
                  </Typography>
                </li>
                <li>
                  <Typography
                    ...
                    className="text-gray-600 leading-relaxed text-regular-sm sm:text-regular-lg"
                  >
                    Feedback, feature requests, or other communication you send
                    to us.
                  </Typography>
                </li>
              </ul>
              ...
              <ul className="list-disc list-outside pl-4 space-y-2">
                <li>
                  <Typography
                    ...
                    className="text-gray-600 leading-relaxed text-regular-sm sm:text-regular-lg"
                  >
                    Usage data (e.g., pages visited, features used, date/time of
                    access).
                  </Typography>
                </li>
                <li>
            ...
            <li className="text-medium-base sm:text-medium-lg">
              ...
              <Typography
                ...
                className="text-gray-600 leading-relaxed text-regular-sm sm:text-regular-lg"
              >
                When you use Eusate to handle customer support, we may process
                your customers’ personal data (e.g., names, emails, conversation
                history). You are the “data controller” for such information;
                Eusate acts as a “data processor” in accordance with your
                instructions.
              </Typography>
            </li>
          </ol>
        ...
        <PolicySection title="3. How We Use Your Information">
          ...
          <Typography
            ...
            className="text-gray-600 mb-2 leading-relaxed text-regular-sm sm:text-regular-lg"
          >
            We do <b>not</b> sell your personal information or customer data.
          </Typography>
        </PolicySection>
          ...
          <ul className="list-disc list-outside space-y-2 pl-4 py-3">
            ...
            <li>
              <Typography
                ...
                className="text-gray-600 leading-relaxed text-regular-sm sm:text-regular-lg"
              >
                Upon request, we will delete or anonymize your data, subject to
          ...
          <ul className="list-disc list-outside space-y-2 pl-4 py-3">
            <li>
              ...
              >
                ...
                platform (e.g., hosting providers, analytics tools).
              </Typography>
            </li>
            <li>
              <Typography
            ...
            <li>
              <Typography
                ...
                className="text-gray-600 leading-relaxed text-regular-sm sm:text-regular-lg"
              >
                To investigate potential violations of our Terms or protect our
        ...
        <PolicySection title="8. International Data Transfers">
          ...
          >
            ...
            and processed in countries where data protection laws may differ
            from yours. We will take appropriate measures to protect your data
        ...
        <PolicySection title="9. Children’s Privacy">
          <Typography
            ...
            className="text-gray-600 leading-relaxed text-regular-sm sm:text-regular-lg"
          >
            Eusate is not directed to individuals under the age of 16. We do not
            knowingly collect personal data from minors. If we learn we have
            collected personal data from a minor, we will delete it promptly.
          </Typography>
        </PolicySection>
        ...
        <PolicySection title="10. Changes to This Policy">
          ...
          >
            ...
            Significant changes may be communicated via email or platform
            notification.
          </Typography>
        </PolicySection>
