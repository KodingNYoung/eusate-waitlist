  ...
  return (
    <PageTemplate classNames={{ wrapper: "md:space-y-24" }}>
      <PageHeader
        ...
        classNames={{
          wrapper: "relative",
          root: "z-3 md:container justify-between !space-y-10",
          container:
            "overflow-hidden bg-[url(/images/reports-bg.webp)] flex items-end h-[80vh] md:h-screen !px-5 !py-12",
          title: "text-white",
        ...
        startContent={
          <div className="absolute left-0 top-[0%] -translate-x-[30%] md:-translate-x-[0%] -translate-y-[180px] md:-translate-y-[280px] z-1">
